...
```{r}
breaks <- cut(peliculas_estado$presupuesto/1000, 0:9, labels=c("0", sprintf("%2f", 1:8)))
```
...
```{r}
world <- ggplot() + borders("world", colour = "black", fill = "gray80") + theme_map() + coord_cartesian(ylim = c(-50, 90)) 
```
...
gganimate(map_animate, interval = 0.2, title_frame =T, ani.width=1600, ani.height=820, dpi=800, "pib_1990_2015.gif")
```
...
gganimate(map_animate, interval = 0.2, ani.width = 1500, ani.height = 750, "CC_1990_2015.gif")
```
